      ...
      <List.Item>
        <Segment>
          ...
          <div>
            ...
            <Segment>
              <div>
                <Label>Item Name</Label>&emsp;{item.item.name}&emsp;&emsp;
                <Label>Quantity</Label>&emsp;{item.item.quantity}&emsp;&emsp;
                <Label>Price per item</Label>&emsp;{item.item.price}&emsp;&emsp;
                <Label>status</Label>&emsp;{item.status}
              </div>
            </Segment>
          </div>
          <div>
            <Label>Total Price</Label>&emsp;{item.totalprice}
          </div>
          <div>
                ...
                <Card color="teal" raised centered>
                  ...
                  <Card.Content>
                    ...
                    <Card.Meta textAlign="center">
                      <br />
                      <span className="date">
                        <Header as="h5">Amount per unit :- 10rs</Header>
                      </span>
                    </Card.Meta>
                ...
                <Card color="teal" raised centered>
                  ...
                  <Card.Content>
                    ...
                    <Card.Meta textAlign="center">
                      <br></br>
                      <span className="date">
                        <Header as="h5">Amount per unit :- 5rs</Header>
                      </span>
                    </Card.Meta>
                  ...
                  <Card.Content extra textAlign="center">
                    <Button color="blue" onClick={() => placeorder(5, "Tea")}>
                      Confirm
                    </Button>
                  </Card.Content>
                </Card>
                ...
                <Card color="teal" raised centered>
                  ...
                  <Card.Content>
                    ...
                    <Card.Meta textAlign="center">
                      <br />
                      <span className="date">
                        <Header as="h5">Amount per liter :- 15rs</Header>
                      </span>
                    </Card.Meta>
          ...
          {db.activeItem == "Profile" && (
            <Segment>
              <List divided selection>
                ...
                <List.Item>
                  <br />
                  <Label horizontal>Email Address</Label>
                  <span style={{ float: "right", marginRight: 40 }}>
                    {db.user.email}
                  </span>
                </List.Item>
                ...
                <List.Item>
                  <br />
                  <Button floated="right" onClick={() => profileedit()}>
                    Edit Profile
                  </Button>
                </List.Item>
              </List>
          ...
          {db.activeItem == "Feedback" && (
            <div>
              ...
              <Form>
                ...
                />
                <Form.Button type="submit" onClick={() => submitfeeds()}>
                  Submit
                </Form.Button>
              </Form>
            </div>
