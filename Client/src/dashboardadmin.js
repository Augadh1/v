    ...
    <Grid>
      ...
      <Grid.Column stretched width={12}>
        <Segment>
            ...
            <Grid columns={2}>
              ...
              <Grid.Column>
                <Segment>
                  ...
                  <h3>
                    Total sales in month (Coffee):{" "}
                    <span style={{ float: "right", marginRight: 40 }}>
                      {db.monthsalescoffee}
                    </span>
                  </h3>
                  <h3>
                    Total sales in month (Tea):{" "}
                    <span style={{ float: "right", marginRight: 40 }}>
                      {db.monthsalestea}
                    </span>
                  </h3>
                  <h3>
                    Total sales in month (Water):{" "}
                    <span style={{ float: "right", marginRight: 40 }}>
                      {db.monthsaleswater}
                    </span>
                  </h3>
                  <h3>
                    Total sales in day (Coffee):{" "}
                    <span style={{ float: "right", marginRight: 40 }}>
                      {db.daysalescoffee}
                    </span>
                  </h3>
                  <h3>
                    Total sales in day (Tea):{" "}
                    <span style={{ float: "right", marginRight: 40 }}>
                      {db.daysalestea}
                    </span>
                  </h3>
                  <h3>
                    Total sales in day (Water):{" "}
                    <span style={{ float: "right", marginRight: 40 }}>
                      {db.daysaleswater}
                    </span>
                  </h3>
          ...
          {db.activeItem == "Register" && (
            <AddUser usersignup={usersignup} handlechange={handlechange} />
          )}
        </Segment>
      </Grid.Column>
    </Grid>
